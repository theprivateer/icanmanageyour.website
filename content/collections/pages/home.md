...
content:
  -
    ...
    title: "Website management you don't have to think about"
    content: |-
      Running a business is hard enough without worrying about your website. I provide ongoing website management for small to medium sized businesses that want their site kept online, secure, and up to date without having to deal with the technical details.

      With over 20 years of professional experience, I am a trusted and reliable web designer and developer who looks after websites so business owners can focus on their work.
    type: hero
    enabled: true
  -
    id: 8yN-A-VHvjpgCZvNp-tYM
    title: 'Support for non-technical and time-poor businesses'
    content: |-
      Many of my clients do not want to learn how hosting, updates, or security patches work. They just want their website to be there when customers need it.

      I work with:

      - Small business owners with limited time
      - Teams without in-house technical staff
      - Businesses that rely on their website but do not want to manage it
  ...
  -
    ...
    title: 'Security fixes and regular maintenance'
    content: |-
  ...
  -
    ...
    title: 'Content updates without the hassle'
    content: |-
  ...
  -
    ...
    title: 'Reliable service at a fair price'
    content: |-
  ...
  -
    ...
    content: |-
      ## Keep your website online and up to date
